...
public class HbaseDemo {
    ...
    public void init(){
        ...
        conf.set("hbase.zookeeper.quorum", "itcast04,itcast05,itcast06");
    }
    ...
    public void testModifyFamily() throws Exception{
        ...
        HColumnDescriptor column = new HColumnDescriptor("base_info");
        column.setMaxVersions(HConstants.ALL_VERSIONS);
